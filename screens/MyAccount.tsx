...
export default function MyAccount() {
  ...
  return (
    <View style={styles.container}>
      <CustomText fontSize="lg" weight="bold" text="Minha conta" color={theme.colors.primary} />
      <View style={styles.info}>
        ...
        <CustomText fontSize="sm" weight="medium" text="Email" color={theme.colors.primary} style={styles.labelTop} />
